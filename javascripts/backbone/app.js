  ...
  var createMapView = Backbone.View.extend({
    ...
    newMap: function(ev){
      ...
      navigator.geolocation.getCurrentPosition(function(position) {
        ...
        combInitializedData.mapCollection.create( {name: mapName, creator_id: responseUserId, user_id: responseUserId, map_lat: latitude, map_long: longitude, id:responseUserId });
